...
const UserDrives = () => {
  ...
  const fetchUserDrives = useCallback(async () => {
    try {
      setLoading(true);
      const response = await authFetch('/api/drives/my-drives');
      ...
      console.error('Error fetching user drives:', err);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading your drives...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">My Plantation Drives</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {drives.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Drives Created Yet</h3>
            <p className="text-gray-600 mb-6">Create your first plantation drive to get started!</p>
            <button
              onClick={() => window.location.href = '/user/create-drive'}
